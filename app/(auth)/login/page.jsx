                ...
                <div className="space-y-1.5 text-left">
                  ...
                  <div className="relative">
                    ...
                    <Input
                      ...
                      value={email}
                      onChange={(e) => setEmail(e.target.value)}
                      className="h-11 pl-10 rounded-lg border-gray-200 focus-visible:ring-[#2b5336] text-sm"
                    />
                  </div>
                </div>
                ...
                <div className="space-y-1.5 text-left">
                  ...
                  <div className="relative">
                    ...
                    <Input
                      ...
                      value={password}
                      onChange={(e) => setPassword(e.target.value)}
                      className="h-11 pl-10 pr-10 rounded-lg border-gray-200 focus-visible:ring-[#2b5336] text-sm"
                    />
                    <button
                      type="button"
